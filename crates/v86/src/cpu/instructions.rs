...
pub unsafe fn instr_00_mem(addr: i32, r: i32) {
    safe_read_write8(addr, &|x| add8(x, read_reg8(r)))
}
pub unsafe fn instr_00_reg(r1: i32, r: i32) {
    write_reg8(r1, add8(read_reg8(r1), read_reg8(r)));
}
...
pub unsafe fn instr_02_reg(r1: i32, r: i32) {
    write_reg8(r, add8(read_reg8(r), read_reg8(r1)));
}
...
pub unsafe fn instr_04(imm8: i32) {
    write_reg8(AL, add8(read_reg8(AL), imm8));
}
pub unsafe fn instr16_05(imm16: i32) {
    write_reg16(AX, add16(read_reg16(AX), imm16));
}
pub unsafe fn instr32_05(imm32: i32) {
    write_reg32(EAX, add32(read_reg32(EAX), imm32));
}
...
pub unsafe fn instr_08_mem(addr: i32, r: i32) {
    safe_read_write8(addr, &|x| or8(x, read_reg8(r)))
}
pub unsafe fn instr_08_reg(r1: i32, r: i32) {
    write_reg8(r1, or8(read_reg8(r1), read_reg8(r)));
}
...
pub unsafe fn instr_0A_reg(r1: i32, r: i32) {
    write_reg8(r, or8(read_reg8(r), read_reg8(r1)));
}
...
pub unsafe fn instr_0C(imm8: i32) {
    write_reg8(AL, or8(read_reg8(AL), imm8));
}
pub unsafe fn instr16_0D(imm16: i32) {
    write_reg16(AX, or16(read_reg16(AX), imm16));
}
pub unsafe fn instr32_0D(imm32: i32) {
    write_reg32(EAX, or32(read_reg32(EAX), imm32));
}
...
pub unsafe fn instr_12_reg(r1: i32, r: i32) {
    write_reg8(r, adc8(read_reg8(r), read_reg8(r1)));
}
...
pub unsafe fn instr_14(imm8: i32) {
    write_reg8(AL, adc8(read_reg8(AL), imm8));
}
pub unsafe fn instr16_15(imm16: i32) {
    write_reg16(AX, adc16(read_reg16(AX), imm16));
}
pub unsafe fn instr32_15(imm32: i32) {
    write_reg32(EAX, adc32(read_reg32(EAX), imm32));
}
...
pub unsafe fn instr_18_mem(addr: i32, r: i32) {
    safe_read_write8(addr, &|x| sbb8(x, read_reg8(r)))
}
pub unsafe fn instr_18_reg(r1: i32, r: i32) {
    write_reg8(r1, sbb8(read_reg8(r1), read_reg8(r)));
}
...
pub unsafe fn instr_1A_reg(r1: i32, r: i32) {
    write_reg8(r, sbb8(read_reg8(r), read_reg8(r1)));
}
...
pub unsafe fn instr_1C(imm8: i32) {
    write_reg8(AL, sbb8(read_reg8(AL), imm8));
}
pub unsafe fn instr16_1D(imm16: i32) {
    write_reg16(AX, sbb16(read_reg16(AX), imm16));
}
pub unsafe fn instr32_1D(imm32: i32) {
    write_reg32(EAX, sbb32(read_reg32(EAX), imm32));
}
...
pub unsafe fn instr_20_mem(addr: i32, r: i32) {
    safe_read_write8(addr, &|x| and8(x, read_reg8(r)))
}
pub unsafe fn instr_20_reg(r1: i32, r: i32) {
    write_reg8(r1, and8(read_reg8(r1), read_reg8(r)));
}
...
pub unsafe fn instr_22_reg(r1: i32, r: i32) {
    write_reg8(r, and8(read_reg8(r), read_reg8(r1)));
}
...
pub unsafe fn instr_24(imm8: i32) {
    write_reg8(AL, and8(read_reg8(AL), imm8));
}
pub unsafe fn instr16_25(imm16: i32) {
    write_reg16(AX, and16(read_reg16(AX), imm16));
}
pub unsafe fn instr32_25(imm32: i32) {
    write_reg32(EAX, and32(read_reg32(EAX), imm32));
}

pub unsafe fn instr_26() {
    segment_prefix_op(ES);
}
...
pub unsafe fn instr_28_mem(addr: i32, r: i32) {
    safe_read_write8(addr, &|x| sub8(x, read_reg8(r)))
}
pub unsafe fn instr_28_reg(r1: i32, r: i32) {
    write_reg8(r1, sub8(read_reg8(r1), read_reg8(r)));
}
...
pub unsafe fn instr_2A_reg(r1: i32, r: i32) {
    write_reg8(r, sub8(read_reg8(r), read_reg8(r1)));
}
...
pub unsafe fn instr_2C(imm8: i32) {
    write_reg8(AL, sub8(read_reg8(AL), imm8));
}
pub unsafe fn instr16_2D(imm16: i32) {
    write_reg16(AX, sub16(read_reg16(AX), imm16));
}
pub unsafe fn instr32_2D(imm32: i32) {
    write_reg32(EAX, sub32(read_reg32(EAX), imm32));
}

pub unsafe fn instr_2E() {
    segment_prefix_op(CS);
}
...
pub unsafe fn instr_30_mem(addr: i32, r: i32) {
    safe_read_write8(addr, &|x| xor8(x, read_reg8(r)))
}
pub unsafe fn instr_30_reg(r1: i32, r: i32) {
    write_reg8(r1, xor8(read_reg8(r1), read_reg8(r)));
}
...
pub unsafe fn instr_32_reg(r1: i32, r: i32) {
    write_reg8(r, xor8(read_reg8(r), read_reg8(r1)));
}
...
pub unsafe fn instr_34(imm8: i32) {
    write_reg8(AL, xor8(read_reg8(AL), imm8));
}
pub unsafe fn instr16_35(imm16: i32) {
    write_reg16(AX, xor16(read_reg16(AX), imm16));
}
pub unsafe fn instr32_35(imm32: i32) {
    write_reg32(EAX, xor32(read_reg32(EAX), imm32));
}

pub unsafe fn instr_36() {
    segment_prefix_op(SS);
}
...
pub unsafe fn instr16_39_reg(r1: i32, r: i32) {
    cmp16(read_reg16(r1), read_reg16(r));
}
...
pub unsafe fn instr32_39_reg(r1: i32, r: i32) {
    cmp32(read_reg32(r1), read_reg32(r));
}
...
pub unsafe fn instr16_3B_reg(r1: i32, r: i32) {
    cmp16(read_reg16(r), read_reg16(r1));
}
...
pub unsafe fn instr32_3B_reg(r1: i32, r: i32) {
    cmp32(read_reg32(r), read_reg32(r1));
}
pub unsafe fn instr_3C(imm8: i32) {
    cmp8(read_reg8(AL), imm8);
}
pub unsafe fn instr16_3D(imm16: i32) {
    cmp16(read_reg16(AX), imm16);
}
pub unsafe fn instr32_3D(imm32: i32) {
    cmp32(read_reg32(EAX), imm32);
}

pub unsafe fn instr_3E() {
    segment_prefix_op(DS);
}
...
pub unsafe fn instr16_40() {
    write_reg16(AX, inc16(read_reg16(AX)));
}
pub unsafe fn instr32_40() {
    write_reg32(EAX, inc32(read_reg32(EAX)));
}
pub unsafe fn instr16_41() {
    write_reg16(CX, inc16(read_reg16(CX)));
}
pub unsafe fn instr32_41() {
    write_reg32(ECX, inc32(read_reg32(ECX)));
}
pub unsafe fn instr16_42() {
    write_reg16(DX, inc16(read_reg16(DX)));
}
pub unsafe fn instr32_42() {
    write_reg32(EDX, inc32(read_reg32(EDX)));
}
pub unsafe fn instr16_43() {
    write_reg16(BX, inc16(read_reg16(BX)));
}
pub unsafe fn instr32_43() {
    write_reg32(EBX, inc32(read_reg32(EBX)));
}
pub unsafe fn instr16_44() {
    write_reg16(SP, inc16(read_reg16(SP)));
}
pub unsafe fn instr32_44() {
    write_reg32(ESP, inc32(read_reg32(ESP)));
}
pub unsafe fn instr16_45() {
    write_reg16(BP, inc16(read_reg16(BP)));
}
pub unsafe fn instr32_45() {
    write_reg32(EBP, inc32(read_reg32(EBP)));
}
pub unsafe fn instr16_46() {
    write_reg16(SI, inc16(read_reg16(SI)));
}
pub unsafe fn instr32_46() {
    write_reg32(ESI, inc32(read_reg32(ESI)));
}
pub unsafe fn instr16_47() {
    write_reg16(DI, inc16(read_reg16(DI)));
}
pub unsafe fn instr32_47() {
    write_reg32(EDI, inc32(read_reg32(EDI)));
}
pub unsafe fn instr16_48() {
    write_reg16(AX, dec16(read_reg16(AX)));
}
pub unsafe fn instr32_48() {
    write_reg32(EAX, dec32(read_reg32(EAX)));
}
pub unsafe fn instr16_49() {
    write_reg16(CX, dec16(read_reg16(CX)));
}
pub unsafe fn instr32_49() {
    write_reg32(ECX, dec32(read_reg32(ECX)));
}
pub unsafe fn instr16_4A() {
    write_reg16(DX, dec16(read_reg16(DX)));
}
pub unsafe fn instr32_4A() {
    write_reg32(EDX, dec32(read_reg32(EDX)));
}
pub unsafe fn instr16_4B() {
    write_reg16(BX, dec16(read_reg16(BX)));
}
pub unsafe fn instr32_4B() {
    write_reg32(EBX, dec32(read_reg32(EBX)));
}
pub unsafe fn instr16_4C() {
    write_reg16(SP, dec16(read_reg16(SP)));
}
pub unsafe fn instr32_4C() {
    write_reg32(ESP, dec32(read_reg32(ESP)));
}
pub unsafe fn instr16_4D() {
    write_reg16(BP, dec16(read_reg16(BP)));
}
pub unsafe fn instr32_4D() {
    write_reg32(EBP, dec32(read_reg32(EBP)));
}
pub unsafe fn instr16_4E() {
    write_reg16(SI, dec16(read_reg16(SI)));
}
pub unsafe fn instr32_4E() {
    write_reg32(ESI, dec32(read_reg32(ESI)));
}
pub unsafe fn instr16_4F() {
    write_reg16(DI, dec16(read_reg16(DI)));
}
pub unsafe fn instr32_4F() {
    write_reg32(EDI, dec32(read_reg32(EDI)));
}
...
pub unsafe fn instr16_50() {
    push16_reg(AX)
}
pub unsafe fn instr32_50() {
    push32_reg(EAX)
}
pub unsafe fn instr16_51() {
    push16_reg(CX)
}
pub unsafe fn instr32_51() {
    push32_reg(ECX)
}
pub unsafe fn instr16_52() {
    push16_reg(DX)
}
pub unsafe fn instr32_52() {
    push32_reg(EDX)
}
pub unsafe fn instr16_53() {
    push16_reg(BX)
}
pub unsafe fn instr32_53() {
    push32_reg(EBX)
}
pub unsafe fn instr16_54() {
    push16_reg(SP)
}
pub unsafe fn instr32_54() {
    push32_reg(ESP)
}
pub unsafe fn instr16_55() {
    push16_reg(BP)
}
pub unsafe fn instr32_55() {
    push32_reg(EBP)
}
pub unsafe fn instr16_56() {
    push16_reg(SI)
}
pub unsafe fn instr32_56() {
    push32_reg(ESI)
}
pub unsafe fn instr16_57() {
    push16_reg(DI)
}
pub unsafe fn instr32_57() {
    push32_reg(EDI)
}
pub unsafe fn instr16_58() {
    write_reg16(AX, return_on_pagefault!(pop16()));
}
pub unsafe fn instr32_58() {
    write_reg32(EAX, return_on_pagefault!(pop32s()));
}
pub unsafe fn instr16_59() {
    write_reg16(CX, return_on_pagefault!(pop16()));
}
pub unsafe fn instr32_59() {
    write_reg32(ECX, return_on_pagefault!(pop32s()));
}
pub unsafe fn instr16_5A() {
    write_reg16(DX, return_on_pagefault!(pop16()));
}
pub unsafe fn instr32_5A() {
    write_reg32(EDX, return_on_pagefault!(pop32s()));
}
pub unsafe fn instr16_5B() {
    write_reg16(BX, return_on_pagefault!(pop16()));
}
pub unsafe fn instr32_5B() {
    write_reg32(EBX, return_on_pagefault!(pop32s()));
}
...
pub unsafe fn instr16_5D() {
    write_reg16(BP, return_on_pagefault!(pop16()));
}
pub unsafe fn instr32_5D() {
    write_reg32(EBP, return_on_pagefault!(pop32s()));
}
pub unsafe fn instr16_5E() {
    write_reg16(SI, return_on_pagefault!(pop16()));
}
pub unsafe fn instr32_5E() {
    write_reg32(ESI, return_on_pagefault!(pop32s()));
}
pub unsafe fn instr16_5F() {
    write_reg16(DI, return_on_pagefault!(pop16()));
}
pub unsafe fn instr32_5F() {
    write_reg32(EDI, return_on_pagefault!(pop32s()));
}

#[no_mangle]
pub unsafe fn instr16_60() {
    pusha16();
}
#[no_mangle]
pub unsafe fn instr32_60() {
    pusha32();
}
#[no_mangle]
pub unsafe fn instr16_61() {
    popa16();
}
#[no_mangle]
pub unsafe fn instr32_61() {
    popa32();
}
...
pub unsafe fn instr_64() {
    segment_prefix_op(FS);
}
pub unsafe fn instr_65() {
    segment_prefix_op(GS);
}
...
pub unsafe fn instr_6C() {
    insb_no_rep(is_asize_32());
}
pub unsafe fn instr_F26C() {
    insb_rep(is_asize_32());
}
pub unsafe fn instr_F36C() {
    insb_rep(is_asize_32());
}
pub unsafe fn instr16_6D() {
    insw_no_rep(is_asize_32());
}
pub unsafe fn instr32_6D() {
    insd_no_rep(is_asize_32());
}
pub unsafe fn instr16_F26D() {
    insw_rep(is_asize_32());
}
pub unsafe fn instr16_F36D() {
    insw_rep(is_asize_32());
}
pub unsafe fn instr32_F26D() {
    insd_rep(is_asize_32());
}
pub unsafe fn instr32_F36D() {
    insd_rep(is_asize_32());
}

pub unsafe fn instr_6E() {
    outsb_no_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr_F26E() {
    outsb_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr_F36E() {
    outsb_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
...
pub unsafe fn instr16_F26F() {
    outsw_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr16_F36F() {
    outsw_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr32_F26F() {
    outsd_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr32_F36F() {
    outsd_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}

pub unsafe fn instr16_70(imm8: i32) {
    jmpcc16(test_o(), imm8);
}
pub unsafe fn instr16_71(imm8: i32) {
    jmpcc16(!test_o(), imm8);
}
pub unsafe fn instr16_72(imm8: i32) {
    jmpcc16(test_b(), imm8);
}
pub unsafe fn instr16_73(imm8: i32) {
    jmpcc16(!test_b(), imm8);
}
pub unsafe fn instr16_74(imm8: i32) {
    jmpcc16(test_z(), imm8);
}
pub unsafe fn instr16_75(imm8: i32) {
    jmpcc16(!test_z(), imm8);
}
pub unsafe fn instr16_76(imm8: i32) {
    jmpcc16(test_be(), imm8);
}
pub unsafe fn instr16_77(imm8: i32) {
    jmpcc16(!test_be(), imm8);
}
pub unsafe fn instr16_78(imm8: i32) {
    jmpcc16(test_s(), imm8);
}
pub unsafe fn instr16_79(imm8: i32) {
    jmpcc16(!test_s(), imm8);
}
pub unsafe fn instr16_7A(imm8: i32) {
    jmpcc16(test_p(), imm8);
}
pub unsafe fn instr16_7B(imm8: i32) {
    jmpcc16(!test_p(), imm8);
}
pub unsafe fn instr16_7C(imm8: i32) {
    jmpcc16(test_l(), imm8);
}
pub unsafe fn instr16_7D(imm8: i32) {
    jmpcc16(!test_l(), imm8);
}
pub unsafe fn instr16_7E(imm8: i32) {
    jmpcc16(test_le(), imm8);
}
pub unsafe fn instr16_7F(imm8: i32) {
    jmpcc16(!test_le(), imm8);
}
pub unsafe fn instr32_70(imm8: i32) {
    jmpcc32(test_o(), imm8);
}
pub unsafe fn instr32_71(imm8: i32) {
    jmpcc32(!test_o(), imm8);
}
pub unsafe fn instr32_72(imm8: i32) {
    jmpcc32(test_b(), imm8);
}
pub unsafe fn instr32_73(imm8: i32) {
    jmpcc32(!test_b(), imm8);
}
pub unsafe fn instr32_74(imm8: i32) {
    jmpcc32(test_z(), imm8);
}
pub unsafe fn instr32_75(imm8: i32) {
    jmpcc32(!test_z(), imm8);
}
pub unsafe fn instr32_76(imm8: i32) {
    jmpcc32(test_be(), imm8);
}
pub unsafe fn instr32_77(imm8: i32) {
    jmpcc32(!test_be(), imm8);
}
pub unsafe fn instr32_78(imm8: i32) {
    jmpcc32(test_s(), imm8);
}
pub unsafe fn instr32_79(imm8: i32) {
    jmpcc32(!test_s(), imm8);
}
pub unsafe fn instr32_7A(imm8: i32) {
    jmpcc32(test_p(), imm8);
}
pub unsafe fn instr32_7B(imm8: i32) {
    jmpcc32(!test_p(), imm8);
}
pub unsafe fn instr32_7C(imm8: i32) {
    jmpcc32(test_l(), imm8);
}
pub unsafe fn instr32_7D(imm8: i32) {
    jmpcc32(!test_l(), imm8);
}
pub unsafe fn instr32_7E(imm8: i32) {
    jmpcc32(test_le(), imm8);
}
pub unsafe fn instr32_7F(imm8: i32) {
    jmpcc32(!test_le(), imm8);
}

pub unsafe fn instr_80_0_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| add8(x, imm))
}
pub unsafe fn instr_80_0_reg(r1: i32, imm: i32) {
    write_reg8(r1, add8(read_reg8(r1), imm));
}
pub unsafe fn instr_80_1_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| or8(x, imm))
}
pub unsafe fn instr_80_1_reg(r1: i32, imm: i32) {
    write_reg8(r1, or8(read_reg8(r1), imm));
}
pub unsafe fn instr_80_2_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| adc8(x, imm))
}
pub unsafe fn instr_80_2_reg(r1: i32, imm: i32) {
    write_reg8(r1, adc8(read_reg8(r1), imm));
}
pub unsafe fn instr_80_3_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| sbb8(x, imm))
}
pub unsafe fn instr_80_3_reg(r1: i32, imm: i32) {
    write_reg8(r1, sbb8(read_reg8(r1), imm));
}
pub unsafe fn instr_80_4_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| and8(x, imm))
}
pub unsafe fn instr_80_4_reg(r1: i32, imm: i32) {
    write_reg8(r1, and8(read_reg8(r1), imm));
}
pub unsafe fn instr_80_5_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| sub8(x, imm))
}
pub unsafe fn instr_80_5_reg(r1: i32, imm: i32) {
    write_reg8(r1, sub8(read_reg8(r1), imm));
}
pub unsafe fn instr_80_6_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| xor8(x, imm))
}
pub unsafe fn instr_80_6_reg(r1: i32, imm: i32) {
    write_reg8(r1, xor8(read_reg8(r1), imm));
}
pub unsafe fn instr_80_7_reg(r: i32, imm: i32) {
    cmp8(read_reg8(r), imm);
}
...
pub unsafe fn instr_82_7_reg(r: i32, imm: i32) {
    cmp8(read_reg8(r), imm);
}
...
pub unsafe fn instr16_83_7_reg(r: i32, imm: i32) {
    cmp16(read_reg16(r), imm);
}
...
pub unsafe fn instr32_83_7_reg(r: i32, imm: i32) {
    cmp32(read_reg32(r), imm);
}
...
pub unsafe fn instr_84_reg(r1: i32, r: i32) {
    test8(read_reg8(r1), read_reg8(r));
}
...
pub unsafe fn instr16_85_reg(r1: i32, r: i32) {
    test16(read_reg16(r1), read_reg16(r));
}
...
pub unsafe fn instr_8E_reg(r1: i32, r: i32) {
    instr_8E_helper(read_reg16(r1), r);
}
...
pub unsafe fn instr16_8F_0_reg(r: i32) {
...
pub unsafe fn instr32_8F_0_reg(r: i32) {
    write_reg32(r, return_on_pagefault!(pop32s()));
}

pub unsafe fn instr_90() {}
pub unsafe fn instr16_91() {
    xchg16r(CX);
}
pub unsafe fn instr32_91() {
    xchg32r(ECX);
}
pub unsafe fn instr16_92() {
    xchg16r(DX);
}
pub unsafe fn instr32_92() {
    xchg32r(EDX);
}
pub unsafe fn instr16_93() {
    xchg16r(BX);
}
pub unsafe fn instr32_93() {
    xchg32r(EBX);
}
pub unsafe fn instr16_94() {
    xchg16r(SP);
}
pub unsafe fn instr32_94() {
    xchg32r(ESP);
}
pub unsafe fn instr16_95() {
    xchg16r(BP);
}
pub unsafe fn instr32_95() {
    xchg32r(EBP);
}
pub unsafe fn instr16_96() {
    xchg16r(SI);
}
pub unsafe fn instr32_96() {
    xchg32r(ESI);
}
pub unsafe fn instr16_97() {
    xchg16r(DI);
}
pub unsafe fn instr32_97() {
    xchg32r(EDI);
}

pub unsafe fn instr16_98() {
    write_reg16(AX, read_reg8(AL) << 24 >> 24);
}
pub unsafe fn instr32_98() {
    write_reg32(EAX, read_reg16(AX) as i16 as i32);
}
pub unsafe fn instr16_99() {
    write_reg16(DX, read_reg16(AX) as i16 as i32 >> 15);
}
pub unsafe fn instr32_99() {
    write_reg32(EDX, read_reg32(EAX) >> 31);
}
...
unsafe fn instr_pushf_popf_check() -> bool {
...
pub unsafe fn instr_A4() {
    movsb_no_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr_F2A4() {
    movsb_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr_F3A4() {
    movsb_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
...
pub unsafe fn instr16_F2A5() {
    movsw_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr16_F3A5() {
    movsw_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr32_F2A5() {
    movsd_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr32_F3A5() {
    movsd_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}

pub unsafe fn instr_A6() {
    cmpsb_no_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr_F2A6() {
    cmpsb_repnz(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr_F3A6() {
    cmpsb_repz(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
...
pub unsafe fn instr_A8(imm8: i32) {
    test8(read_reg8(AL), imm8);
}
pub unsafe fn instr16_A9(imm16: i32) {
    test16(read_reg16(AX), imm16);
}
pub unsafe fn instr32_A9(imm32: i32) {
    test32(read_reg32(EAX), imm32);
}

pub unsafe fn instr_AA() {
    stosb_no_rep(is_asize_32());
}
pub unsafe fn instr_F2AA() {
    stosb_rep(is_asize_32());
}
pub unsafe fn instr_F3AA() {
    stosb_rep(is_asize_32());
}

pub unsafe fn instr16_AB() {
    stosw_no_rep(is_asize_32());
}
pub unsafe fn instr32_AB() {
    stosd_no_rep(is_asize_32());
}
pub unsafe fn instr16_F2AB() {
    stosw_rep(is_asize_32());
}
pub unsafe fn instr16_F3AB() {
    stosw_rep(is_asize_32());
}
pub unsafe fn instr32_F2AB() {
    stosd_rep(is_asize_32());
}
pub unsafe fn instr32_F3AB() {
    stosd_rep(is_asize_32());
}

pub unsafe fn instr_AC() {
    lodsb_no_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr_F2AC() {
    lodsb_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr_F3AC() {
    lodsb_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
...
pub unsafe fn instr16_F2AD() {
    lodsw_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr16_F3AD() {
    lodsw_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr32_F2AD() {
    lodsd_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}
pub unsafe fn instr32_F3AD() {
    lodsd_rep(is_asize_32(), return_on_pagefault!(get_seg_prefix(DS)));
}

pub unsafe fn instr_AE() {
    scasb_no_rep(is_asize_32());
}
pub unsafe fn instr_F2AE() {
    scasb_repnz(is_asize_32());
}
pub unsafe fn instr_F3AE() {
    scasb_repz(is_asize_32());
}

pub unsafe fn instr16_AF() {
    scasw_no_rep(is_asize_32());
}
pub unsafe fn instr32_AF() {
    scasd_no_rep(is_asize_32());
}
pub unsafe fn instr16_F2AF() {
    scasw_repnz(is_asize_32());
}
pub unsafe fn instr16_F3AF() {
    scasw_repz(is_asize_32());
}
pub unsafe fn instr32_F2AF() {
    scasd_repnz(is_asize_32());
}
pub unsafe fn instr32_F3AF() {
    scasd_repz(is_asize_32());
}

pub unsafe fn instr_B0(imm8: i32) {
    write_reg8(AL, imm8);
}
pub unsafe fn instr_B1(imm8: i32) {
    write_reg8(CL, imm8);
}
pub unsafe fn instr_B2(imm8: i32) {
    write_reg8(DL, imm8);
}
pub unsafe fn instr_B3(imm8: i32) {
    write_reg8(BL, imm8);
}
pub unsafe fn instr_B4(imm8: i32) {
    write_reg8(AH, imm8);
}
pub unsafe fn instr_B5(imm8: i32) {
    write_reg8(CH, imm8);
}
pub unsafe fn instr_B6(imm8: i32) {
    write_reg8(DH, imm8);
}
pub unsafe fn instr_B7(imm8: i32) {
    write_reg8(BH, imm8);
}
pub unsafe fn instr16_B8(imm: i32) {
    write_reg16(AX, imm);
}
pub unsafe fn instr32_B8(imm: i32) {
    write_reg32(EAX, imm);
}
pub unsafe fn instr16_B9(imm: i32) {
    write_reg16(CX, imm);
}
pub unsafe fn instr32_B9(imm: i32) {
    write_reg32(ECX, imm);
}
pub unsafe fn instr16_BA(imm: i32) {
    write_reg16(DX, imm);
}
pub unsafe fn instr32_BA(imm: i32) {
    write_reg32(EDX, imm);
}
pub unsafe fn instr16_BB(imm: i32) {
    write_reg16(BX, imm);
}
pub unsafe fn instr32_BB(imm: i32) {
    write_reg32(EBX, imm);
}
pub unsafe fn instr16_BC(imm: i32) {
    write_reg16(SP, imm);
}
pub unsafe fn instr32_BC(imm: i32) {
    write_reg32(ESP, imm);
}
pub unsafe fn instr16_BD(imm: i32) {
    write_reg16(BP, imm);
}
pub unsafe fn instr32_BD(imm: i32) {
    write_reg32(EBP, imm);
}
pub unsafe fn instr16_BE(imm: i32) {
    write_reg16(SI, imm);
}
pub unsafe fn instr32_BE(imm: i32) {
    write_reg32(ESI, imm);
}
pub unsafe fn instr16_BF(imm: i32) {
    write_reg16(DI, imm);
}
pub unsafe fn instr32_BF(imm: i32) {
    write_reg32(EDI, imm);
}

pub unsafe fn instr_C0_0_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| rol8(x, imm & 31))
}
pub unsafe fn instr_C0_0_reg(r1: i32, imm: i32) {
    write_reg8(r1, rol8(read_reg8(r1), imm & 31));
}
pub unsafe fn instr_C0_1_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| ror8(x, imm & 31))
}
pub unsafe fn instr_C0_1_reg(r1: i32, imm: i32) {
    write_reg8(r1, ror8(read_reg8(r1), imm & 31));
}
pub unsafe fn instr_C0_2_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| rcl8(x, imm & 31))
}
pub unsafe fn instr_C0_2_reg(r1: i32, imm: i32) {
    write_reg8(r1, rcl8(read_reg8(r1), imm & 31));
}
pub unsafe fn instr_C0_3_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| rcr8(x, imm & 31))
}
pub unsafe fn instr_C0_3_reg(r1: i32, imm: i32) {
    write_reg8(r1, rcr8(read_reg8(r1), imm & 31));
}
pub unsafe fn instr_C0_4_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| shl8(x, imm & 31))
}
pub unsafe fn instr_C0_4_reg(r1: i32, imm: i32) {
    write_reg8(r1, shl8(read_reg8(r1), imm & 31));
}
pub unsafe fn instr_C0_5_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| shr8(x, imm & 31))
}
pub unsafe fn instr_C0_5_reg(r1: i32, imm: i32) {
    write_reg8(r1, shr8(read_reg8(r1), imm & 31));
}
...
pub unsafe fn instr_C0_7_mem(addr: i32, imm: i32) {
    safe_read_write8(addr, &|x| sar8(x, imm & 31))
}
pub unsafe fn instr_C0_7_reg(r1: i32, imm: i32) {
    write_reg8(r1, sar8(read_reg8(r1), imm & 31));
}
...
#[no_mangle]
pub unsafe fn instr16_C4_reg(_unused1: i32, _unused2: i32) {
    trigger_ud();
}
#[no_mangle]
pub unsafe fn instr16_C4_mem(addr: i32, r: i32) {
    lss16(addr, r, ES);
}
#[no_mangle]
pub unsafe fn instr32_C4_reg(_unused1: i32, _unused2: i32) {
    trigger_ud();
}
#[no_mangle]
pub unsafe fn instr32_C4_mem(addr: i32, r: i32) {
    lss32(addr, r, ES);
}
#[no_mangle]
pub unsafe fn instr16_C5_reg(_unused1: i32, _unused2: i32) {
    trigger_ud();
}
#[no_mangle]
pub unsafe fn instr16_C5_mem(addr: i32, r: i32) {
    lss16(addr, r, DS);
}
#[no_mangle]
pub unsafe fn instr32_C5_reg(_unused1: i32, _unused2: i32) {
    trigger_ud();
}
#[no_mangle]
pub unsafe fn instr32_C5_mem(addr: i32, r: i32) {
    lss32(addr, r, DS);
}

pub unsafe fn instr_C6_0_reg(r: i32, imm: i32) {
    write_reg8(r, imm);
}
pub unsafe fn instr_C6_0_mem(addr: i32, imm: i32) {
    return_on_pagefault!(safe_write8(addr, imm));
}
pub unsafe fn instr16_C7_0_reg(r: i32, imm: i32) {
    write_reg16(r, imm);
}
pub unsafe fn instr16_C7_0_mem(addr: i32, imm: i32) {
    return_on_pagefault!(safe_write16(addr, imm));
}
pub unsafe fn instr32_C7_0_reg(r: i32, imm: i32) {
    write_reg32(r, imm);
}
...
#[no_mangle]
pub unsafe fn instr16_C8(size: i32, nesting: i32) {
    enter16(size, nesting);
}
#[no_mangle]
pub unsafe fn instr32_C8(size: i32, nesting: i32) {
...
pub unsafe fn instr32_D1_7_mem(addr: i32) {
    safe_read_write32(addr, &|x| sar32(x, 1))
}
pub unsafe fn instr32_D1_7_reg(r1: i32) {
    write_reg32(r1, sar32(read_reg32(r1), 1));
}
pub unsafe fn instr_D2_0_mem(addr: i32) {
    safe_read_write8(addr, &|x| rol8(x, read_reg8(CL) & 31))
}
pub unsafe fn instr_D2_0_reg(r1: i32) {
    write_reg8(r1, rol8(read_reg8(r1), read_reg8(CL) & 31));
}
pub unsafe fn instr_D2_1_mem(addr: i32) {
    safe_read_write8(addr, &|x| ror8(x, read_reg8(CL) & 31))
}
pub unsafe fn instr_D2_1_reg(r1: i32) {
    write_reg8(r1, ror8(read_reg8(r1), read_reg8(CL) & 31));
}
pub unsafe fn instr_D2_2_mem(addr: i32) {
    safe_read_write8(addr, &|x| rcl8(x, read_reg8(CL) & 31))
}
pub unsafe fn instr_D2_2_reg(r1: i32) {
    write_reg8(r1, rcl8(read_reg8(r1), read_reg8(CL) & 31));
}
pub unsafe fn instr_D2_3_mem(addr: i32) {
    safe_read_write8(addr, &|x| rcr8(x, read_reg8(CL) & 31))
}
pub unsafe fn instr_D2_3_reg(r1: i32) {
    write_reg8(r1, rcr8(read_reg8(r1), read_reg8(CL) & 31));
}
pub unsafe fn instr_D2_4_mem(addr: i32) {
    safe_read_write8(addr, &|x| shl8(x, read_reg8(CL) & 31))
}
pub unsafe fn instr_D2_4_reg(r1: i32) {
    write_reg8(r1, shl8(read_reg8(r1), read_reg8(CL) & 31));
}
pub unsafe fn instr_D2_5_mem(addr: i32) {
    safe_read_write8(addr, &|x| shr8(x, read_reg8(CL) & 31))
}
pub unsafe fn instr_D2_5_reg(r1: i32) {
    write_reg8(r1, shr8(read_reg8(r1), read_reg8(CL) & 31));
}
...
pub unsafe fn instr_D2_7_mem(addr: i32) {
    safe_read_write8(addr, &|x| sar8(x, read_reg8(CL) & 31))
}
pub unsafe fn instr_D2_7_reg(r1: i32) {
    write_reg8(r1, sar8(read_reg8(r1), read_reg8(CL) & 31));
}
...
#[no_mangle]
pub unsafe fn instr_D4(arg: i32) {
    bcd_aam(arg);
}
#[no_mangle]
pub unsafe fn instr_D5(arg: i32) {
    bcd_aad(arg);
}
#[no_mangle]
...
pub unsafe fn instr_D8_0_mem(addr: i32) {
    fpu_fadd(0, return_on_pagefault!(fpu_load_m32(addr)));
}
pub unsafe fn instr_D8_0_reg(r: i32) {
    fpu_fadd(0, fpu_get_sti(r));
}
pub unsafe fn instr_D8_1_mem(addr: i32) {
    fpu_fmul(0, return_on_pagefault!(fpu_load_m32(addr)));
}
pub unsafe fn instr_D8_1_reg(r: i32) {
    fpu_fmul(0, fpu_get_sti(r));
}
pub unsafe fn instr_D8_2_mem(addr: i32) {
    fpu_fcom(return_on_pagefault!(fpu_load_m32(addr)));
}
pub unsafe fn instr_D8_2_reg(r: i32) {
    fpu_fcom(fpu_get_sti(r));
}
pub unsafe fn instr_D8_3_mem(addr: i32) {
    fpu_fcomp(return_on_pagefault!(fpu_load_m32(addr)));
}
pub unsafe fn instr_D8_3_reg(r: i32) {
    fpu_fcomp(fpu_get_sti(r));
}
pub unsafe fn instr_D8_4_mem(addr: i32) {
    fpu_fsub(0, return_on_pagefault!(fpu_load_m32(addr)));
}
pub unsafe fn instr_D8_4_reg(r: i32) {
    fpu_fsub(0, fpu_get_sti(r));
}
pub unsafe fn instr_D8_5_mem(addr: i32) {
    fpu_fsubr(0, return_on_pagefault!(fpu_load_m32(addr)));
}
pub unsafe fn instr_D8_5_reg(r: i32) {
    fpu_fsubr(0, fpu_get_sti(r));
}
pub unsafe fn instr_D8_6_mem(addr: i32) {
    fpu_fdiv(0, return_on_pagefault!(fpu_load_m32(addr)));
}
pub unsafe fn instr_D8_6_reg(r: i32) {
    fpu_fdiv(0, fpu_get_sti(r));
}
pub unsafe fn instr_D8_7_mem(addr: i32) {
    fpu_fdivr(0, return_on_pagefault!(fpu_load_m32(addr)));
}
pub unsafe fn instr_D8_7_reg(r: i32) {
    fpu_fdivr(0, fpu_get_sti(r));
}

pub unsafe fn instr16_D9_0_mem(addr: i32) {
    fpu_fldm32(addr);
}
pub unsafe fn instr16_D9_0_reg(r: i32) {
    fpu_push(fpu_get_sti(r));
}
pub unsafe fn instr16_D9_1_mem(_addr: i32) {
    dbg_log!("d9/1");
    trigger_ud();
}
pub unsafe fn instr16_D9_1_reg(r: i32) {
    fpu_fxch(r);
}
pub unsafe fn instr16_D9_2_mem(addr: i32) {
    fpu_fstm32(addr);
}
...
pub unsafe fn instr16_D9_3_mem(addr: i32) {
    fpu_fstm32p(addr);
}
pub unsafe fn instr16_D9_3_reg(r: i32) {
    fpu_fstp(r)
}
#[no_mangle]
...
#[no_mangle]
pub unsafe fn instr16_D9_5_mem(addr: i32) {
    fpu_fldcw(addr);
}
#[no_mangle]
...
pub unsafe fn instr16_D9_7_mem(addr: i32) {
    fpu_fstcw(addr);
}
#[no_mangle]
...
pub unsafe fn instr32_D9_0_reg(r: i32) {
    instr16_D9_0_reg(r)
}
pub unsafe fn instr32_D9_1_reg(r: i32) {
    instr16_D9_1_reg(r)
}
pub unsafe fn instr32_D9_2_reg(r: i32) {
    instr16_D9_2_reg(r)
}
pub unsafe fn instr32_D9_3_reg(r: i32) {
    instr16_D9_3_reg(r)
}
pub unsafe fn instr32_D9_4_reg(r: i32) {
    instr16_D9_4_reg(r)
}
pub unsafe fn instr32_D9_5_reg(r: i32) {
    instr16_D9_5_reg(r)
}
pub unsafe fn instr32_D9_6_reg(r: i32) {
    instr16_D9_6_reg(r)
}
pub unsafe fn instr32_D9_7_reg(r: i32) {
    instr16_D9_7_reg(r)
}

pub unsafe fn instr32_D9_0_mem(r: i32) {
    instr16_D9_0_mem(r)
}
pub unsafe fn instr32_D9_1_mem(r: i32) {
    instr16_D9_1_mem(r)
}
pub unsafe fn instr32_D9_2_mem(r: i32) {
    instr16_D9_2_mem(r)
}
pub unsafe fn instr32_D9_3_mem(r: i32) {
    instr16_D9_3_mem(r)
}
pub unsafe fn instr32_D9_5_mem(r: i32) {
    instr16_D9_5_mem(r)
}
pub unsafe fn instr32_D9_7_mem(r: i32) {
    instr16_D9_7_mem(r)
}

#[no_mangle]
pub unsafe fn instr_DA_0_mem(addr: i32) {
    fpu_fadd(0, return_on_pagefault!(fpu_load_i32(addr)));
}
#[no_mangle]
pub unsafe fn instr_DA_1_mem(addr: i32) {
    fpu_fmul(0, return_on_pagefault!(fpu_load_i32(addr)));
}
#[no_mangle]
pub unsafe fn instr_DA_2_mem(addr: i32) {
    fpu_fcom(return_on_pagefault!(fpu_load_i32(addr)));
}
#[no_mangle]
pub unsafe fn instr_DA_3_mem(addr: i32) {
    fpu_fcomp(return_on_pagefault!(fpu_load_i32(addr)));
}
#[no_mangle]
pub unsafe fn instr_DA_4_mem(addr: i32) {
    fpu_fsub(0, return_on_pagefault!(fpu_load_i32(addr)));
}
#[no_mangle]
pub unsafe fn instr_DA_5_mem(addr: i32) {
    fpu_fsubr(0, return_on_pagefault!(fpu_load_i32(addr)));
}
#[no_mangle]
pub unsafe fn instr_DA_6_mem(addr: i32) {
    fpu_fdiv(0, return_on_pagefault!(fpu_load_i32(addr)));
}
#[no_mangle]
pub unsafe fn instr_DA_7_mem(addr: i32) {
    fpu_fdivr(0, return_on_pagefault!(fpu_load_i32(addr)));
}
#[no_mangle]
pub unsafe fn instr_DA_0_reg(r: i32) {
    fpu_fcmovcc(test_b(), r);
}
#[no_mangle]
pub unsafe fn instr_DA_1_reg(r: i32) {
    fpu_fcmovcc(test_z(), r);
}
#[no_mangle]
pub unsafe fn instr_DA_2_reg(r: i32) {
    fpu_fcmovcc(test_be(), r);
}
#[no_mangle]
pub unsafe fn instr_DA_3_reg(r: i32) {
    fpu_fcmovcc(test_p(), r);
}
#[no_mangle]
pub unsafe fn instr_DA_4_reg(_r: i32) {
    trigger_ud();
}
...
#[no_mangle]
pub unsafe fn instr_DA_6_reg(_r: i32) {
    trigger_ud();
}
#[no_mangle]
pub unsafe fn instr_DA_7_reg(_r: i32) {
    trigger_ud();
}

pub unsafe fn instr_DB_0_mem(addr: i32) {
    fpu_fildm32(addr);
}
#[no_mangle]
...
pub unsafe fn instr_DB_2_mem(addr: i32) {
    fpu_fistm32(addr);
}
pub unsafe fn instr_DB_3_mem(addr: i32) {
    fpu_fistm32p(addr);
}
#[no_mangle]
pub unsafe fn instr_DB_4_mem(_addr: i32) {
    trigger_ud();
}
pub unsafe fn instr_DB_5_mem(addr: i32) {
    fpu_fldm80(addr);
}
pub unsafe fn instr_DB_6_mem(_addr: i32) {
    trigger_ud();
}
#[no_mangle]
pub unsafe fn instr_DB_7_mem(addr: i32) {
    fpu_fst80p(addr);
}
#[no_mangle]
pub unsafe fn instr_DB_0_reg(r: i32) {
    fpu_fcmovcc(!test_b(), r);
}
#[no_mangle]
pub unsafe fn instr_DB_1_reg(r: i32) {
    fpu_fcmovcc(!test_z(), r);
}
#[no_mangle]
pub unsafe fn instr_DB_2_reg(r: i32) {
    fpu_fcmovcc(!test_be(), r);
}
#[no_mangle]
pub unsafe fn instr_DB_3_reg(r: i32) {
    fpu_fcmovcc(!test_p(), r);
}
#[no_mangle]
...
pub unsafe fn instr_DB_5_reg(r: i32) {
    fpu_fucomi(r);
}
pub unsafe fn instr_DB_6_reg(r: i32) {
    fpu_fcomi(r);
}
#[no_mangle]
pub unsafe fn instr_DB_7_reg(_r: i32) {
    trigger_ud();
}

pub unsafe fn instr_DC_0_mem(addr: i32) {
    fpu_fadd(0, return_on_pagefault!(fpu_load_m64(addr)));
}
pub unsafe fn instr_DC_1_mem(addr: i32) {
    fpu_fmul(0, return_on_pagefault!(fpu_load_m64(addr)));
}
pub unsafe fn instr_DC_2_mem(addr: i32) {
    fpu_fcom(return_on_pagefault!(fpu_load_m64(addr)));
}
pub unsafe fn instr_DC_3_mem(addr: i32) {
    fpu_fcomp(return_on_pagefault!(fpu_load_m64(addr)));
}
pub unsafe fn instr_DC_4_mem(addr: i32) {
    fpu_fsub(0, return_on_pagefault!(fpu_load_m64(addr)));
}
pub unsafe fn instr_DC_5_mem(addr: i32) {
    fpu_fsubr(0, return_on_pagefault!(fpu_load_m64(addr)));
}
pub unsafe fn instr_DC_6_mem(addr: i32) {
    fpu_fdiv(0, return_on_pagefault!(fpu_load_m64(addr)));
}
pub unsafe fn instr_DC_7_mem(addr: i32) {
    fpu_fdivr(0, return_on_pagefault!(fpu_load_m64(addr)));
}
pub unsafe fn instr_DC_0_reg(r: i32) {
    fpu_fadd(r, fpu_get_sti(r));
}
pub unsafe fn instr_DC_1_reg(r: i32) {
    fpu_fmul(r, fpu_get_sti(r));
}
pub unsafe fn instr_DC_2_reg(r: i32) {
    fpu_fcom(fpu_get_sti(r));
}
pub unsafe fn instr_DC_3_reg(r: i32) {
    fpu_fcomp(fpu_get_sti(r));
}
pub unsafe fn instr_DC_4_reg(r: i32) {
    fpu_fsub(r, fpu_get_sti(r));
}
pub unsafe fn instr_DC_5_reg(r: i32) {
    fpu_fsubr(r, fpu_get_sti(r));
}
pub unsafe fn instr_DC_6_reg(r: i32) {
    fpu_fdiv(r, fpu_get_sti(r));
}
pub unsafe fn instr_DC_7_reg(r: i32) {
    fpu_fdivr(r, fpu_get_sti(r));
}

pub unsafe fn instr16_DD_0_mem(addr: i32) {
    fpu_fldm64(addr);
}
#[no_mangle]
...
pub unsafe fn instr16_DD_2_mem(addr: i32) {
    fpu_fstm64(addr);
}
pub unsafe fn instr16_DD_3_mem(addr: i32) {
    fpu_fstm64p(addr);
}
#[no_mangle]
pub unsafe fn instr16_DD_4_mem(addr: i32) {
    fpu_frstor16(addr);
}
#[no_mangle]
pub unsafe fn instr32_DD_4_mem(addr: i32) {
    fpu_frstor32(addr);
}
...
#[no_mangle]
pub unsafe fn instr16_DD_6_mem(addr: i32) {
    fpu_fsave16(addr);
}
#[no_mangle]
pub unsafe fn instr32_DD_6_mem(addr: i32) {
    fpu_fsave32(addr);
}
#[no_mangle]
pub unsafe fn instr16_DD_7_mem(addr: i32) {
    fpu_fnstsw_mem(addr);
}
pub unsafe fn instr16_DD_0_reg(r: i32) {
    fpu_ffree(r);
}
#[no_mangle]
pub unsafe fn instr16_DD_1_reg(r: i32) {
    fpu_fxch(r)
}
pub unsafe fn instr16_DD_2_reg(r: i32) {
    fpu_fst(r);
}
pub unsafe fn instr16_DD_3_reg(r: i32) {
    fpu_fstp(r);
}
#[no_mangle]
pub unsafe fn instr16_DD_4_reg(r: i32) {
    fpu_fucom(r);
}
pub unsafe fn instr16_DD_5_reg(r: i32) {
    fpu_fucomp(r);
}
#[no_mangle]
pub unsafe fn instr16_DD_6_reg(_r: i32) {
    trigger_ud();
}
#[no_mangle]
pub unsafe fn instr16_DD_7_reg(_r: i32) {
    trigger_ud();
}

pub unsafe fn instr32_DD_0_reg(r: i32) {
    instr16_DD_0_reg(r)
}
#[no_mangle]
pub unsafe fn instr32_DD_1_reg(r: i32) {
    instr16_DD_1_reg(r)
}
pub unsafe fn instr32_DD_2_reg(r: i32) {
    instr16_DD_2_reg(r)
}
pub unsafe fn instr32_DD_3_reg(r: i32) {
    instr16_DD_3_reg(r)
}
#[no_mangle]
pub unsafe fn instr32_DD_4_reg(r: i32) {
    instr16_DD_4_reg(r)
}
pub unsafe fn instr32_DD_5_reg(r: i32) {
    instr16_DD_5_reg(r)
}
#[no_mangle]
pub unsafe fn instr32_DD_6_reg(r: i32) {
    instr16_DD_6_reg(r)
}
#[no_mangle]
pub unsafe fn instr32_DD_7_reg(r: i32) {
    instr16_DD_7_reg(r)
}

pub unsafe fn instr32_DD_0_mem(r: i32) {
    instr16_DD_0_mem(r)
}
#[no_mangle]
pub unsafe fn instr32_DD_1_mem(r: i32) {
    instr16_DD_1_mem(r)
}
pub unsafe fn instr32_DD_2_mem(r: i32) {
    instr16_DD_2_mem(r)
}
pub unsafe fn instr32_DD_3_mem(r: i32) {
    instr16_DD_3_mem(r)
}
pub unsafe fn instr32_DD_5_mem(r: i32) {
    instr16_DD_5_mem(r)
}
#[no_mangle]
pub unsafe fn instr32_DD_7_mem(r: i32) {
    instr16_DD_7_mem(r)
}

#[no_mangle]
pub unsafe fn instr_DE_0_mem(addr: i32) {
    fpu_fadd(0, return_on_pagefault!(fpu_load_i16(addr)));
}
#[no_mangle]
pub unsafe fn instr_DE_1_mem(addr: i32) {
    fpu_fmul(0, return_on_pagefault!(fpu_load_i16(addr)));
}
#[no_mangle]
pub unsafe fn instr_DE_2_mem(addr: i32) {
    fpu_fcom(return_on_pagefault!(fpu_load_i16(addr)));
}
#[no_mangle]
pub unsafe fn instr_DE_3_mem(addr: i32) {
    fpu_fcomp(return_on_pagefault!(fpu_load_i16(addr)));
}
#[no_mangle]
pub unsafe fn instr_DE_4_mem(addr: i32) {
    fpu_fsub(0, return_on_pagefault!(fpu_load_i16(addr)));
}
#[no_mangle]
pub unsafe fn instr_DE_5_mem(addr: i32) {
    fpu_fsubr(0, return_on_pagefault!(fpu_load_i16(addr)));
}
#[no_mangle]
pub unsafe fn instr_DE_6_mem(addr: i32) {
    fpu_fdiv(0, return_on_pagefault!(fpu_load_i16(addr)));
}
#[no_mangle]
pub unsafe fn instr_DE_7_mem(addr: i32) {
    fpu_fdivr(0, return_on_pagefault!(fpu_load_i16(addr)));
}
...
pub unsafe fn instr_DF_2_mem(addr: i32) {
    fpu_fistm16(addr);
}
pub unsafe fn instr_DF_3_mem(addr: i32) {
    fpu_fistm16p(addr);
}
...
pub unsafe fn instr_DF_5_mem(addr: i32) {
    fpu_fildm64(addr);
}
#[no_mangle]
...
pub unsafe fn instr_DF_7_mem(addr: i32) {
    fpu_fistm64p(addr);
}
...
pub unsafe fn instr_DF_2_reg(r: i32) {
    fpu_fstp(r);
}
pub unsafe fn instr_DF_3_reg(r: i32) {
    fpu_fstp(r);
}
...
pub unsafe fn instr_DF_5_reg(r: i32) {
    fpu_fucomip(r);
}
#[no_mangle]
pub unsafe fn instr_DF_6_reg(r: i32) {
    fpu_fcomip(r);
}
pub unsafe fn instr_DF_7_reg(_r: i32) {
    trigger_ud();
}

pub unsafe fn instr16_E0(imm8s: i32) {
    loopne16(imm8s);
}
pub unsafe fn instr16_E1(imm8s: i32) {
    loope16(imm8s);
}
pub unsafe fn instr16_E2(imm8s: i32) {
    loop16(imm8s);
}
pub unsafe fn instr16_E3(imm8s: i32) {
    jcxz16(imm8s);
}
pub unsafe fn instr32_E0(imm8s: i32) {
    loopne32(imm8s);
}
pub unsafe fn instr32_E1(imm8s: i32) {
    loope32(imm8s);
}
pub unsafe fn instr32_E2(imm8s: i32) {
    loop32(imm8s);
}
pub unsafe fn instr32_E3(imm8s: i32) {
    jcxz32(imm8s);
}
...
pub unsafe fn instr_F6_2_mem(addr: i32) {
    safe_read_write8(addr, &|x| !x)
}
#[no_mangle]
pub unsafe fn instr_F6_2_reg(r1: i32) {
    write_reg8(r1, !read_reg8(r1));
}
#[no_mangle]
pub unsafe fn instr_F6_3_mem(addr: i32) {
    safe_read_write8(addr, &|x| neg8(x))
}
#[no_mangle]
pub unsafe fn instr_F6_3_reg(r1: i32) {
    write_reg8(r1, neg8(read_reg8(r1)));
}
#[no_mangle]
pub unsafe fn instr_F6_4_mem(addr: i32) {
    mul8(return_on_pagefault!(safe_read8(addr)));
}
#[no_mangle]
...
pub unsafe fn instr_F6_5_reg(r1: i32) {
    imul8(read_reg8(r1) << 24 >> 24);
}
#[no_mangle]
pub unsafe fn instr_F6_6_mem(addr: i32) {
    div8(return_on_pagefault!(safe_read8(addr)) as u32);
}
#[no_mangle]
pub unsafe fn instr_F6_6_reg(r1: i32) {
    div8(read_reg8(r1) as u32);
}
#[no_mangle]
...
pub unsafe fn instr16_F7_2_mem(addr: i32) {
    safe_read_write16(addr, &|x| !x)
}
pub unsafe fn instr16_F7_2_reg(r1: i32) {
    write_reg16(r1, !read_reg16(r1));
}
pub unsafe fn instr16_F7_3_mem(addr: i32) {
    safe_read_write16(addr, &|x| neg16(x))
}
pub unsafe fn instr16_F7_3_reg(r1: i32) {
    write_reg16(r1, neg16(read_reg16(r1)));
}
pub unsafe fn instr16_F7_4_mem(addr: i32) {
    mul16(return_on_pagefault!(safe_read16(addr)) as u32);
}
pub unsafe fn instr16_F7_4_reg(r1: i32) {
    mul16(read_reg16(r1) as u32);
}
...
pub unsafe fn instr16_F7_5_reg(r1: i32) {
    imul16(read_reg16(r1) << 16 >> 16);
}
pub unsafe fn instr16_F7_6_mem(addr: i32) {
    div16(return_on_pagefault!(safe_read16(addr)) as u32);
}
pub unsafe fn instr16_F7_6_reg(r1: i32) {
    div16(read_reg16(r1) as u32);
}
...
pub unsafe fn instr32_F7_6_reg(r1: i32) {
    div32(read_reg32(r1) as u32);
}
pub unsafe fn instr32_F7_7_mem(addr: i32) {
    idiv32(return_on_pagefault!(safe_read32s(addr)));
}
pub unsafe fn instr32_F7_7_reg(r1: i32) {
    idiv32(read_reg32(r1));
}
...
pub unsafe fn instr16_FF_2_reg(r1: i32) {
    instr16_FF_2_helper(read_reg16(r1));
}
...
pub unsafe fn instr16_FF_4_reg(r1: i32) {
    instr16_FF_4_helper(read_reg16(r1));
}
...
pub unsafe fn instr32_FF_0_mem(addr: i32) {
    safe_read_write32(addr, &|x| inc32(x))
}
pub unsafe fn instr32_FF_0_reg(r1: i32) {
    write_reg32(r1, inc32(read_reg32(r1)));
}
pub unsafe fn instr32_FF_1_mem(addr: i32) {
    safe_read_write32(addr, &|x| dec32(x))
}
pub unsafe fn instr32_FF_1_reg(r1: i32) {
    write_reg32(r1, dec32(read_reg32(r1)));
}
...
pub unsafe fn instr32_FF_2_reg(r1: i32) {
    instr32_FF_2_helper(read_reg32(r1));
}
#[no_mangle]
...
pub unsafe fn instr32_FF_4_reg(r1: i32) {
    instr32_FF_4_helper(read_reg32(r1));
}
